...
python 'evaluation/01-bge-m3-similarity/BGE-M3稀疏相似度计算.py'
python 'evaluation/01-bge-m3-similarity/BGE-M3综合相似度计算.py'
...
Additional commands and file descriptions are available in [evaluation/README.md](evaluation/README.md), [evaluation/README_CN.md](evaluation/README_CN.md), and [docs/REPRODUCIBILITY.md](docs/REPRODUCIBILITY.md).
